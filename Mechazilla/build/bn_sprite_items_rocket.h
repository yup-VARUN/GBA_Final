...
{
    constexpr inline sprite_item rocket(sprite_shape_size(sprite_shape::WIDE, sprite_size::HUGE), 
            sprite_tiles_item(span<const tile>(rocket_bn_gfxTiles, 128), bpp_mode::BPP_8, compression_type::NONE, 2), 
