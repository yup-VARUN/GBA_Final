...
{
    constexpr inline sprite_item flame_sprite(sprite_shape_size(sprite_shape::WIDE, sprite_size::HUGE), 
            sprite_tiles_item(span<const tile>(flame_sprite_bn_gfxTiles, 128), bpp_mode::BPP_8, compression_type::NONE, 2), 
